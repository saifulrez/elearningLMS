                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<div class="pull-right">
												Check All <input type="checkbox"  name="selectAll" id="checkAll" style="
    margin-top: -5px;
" />
												<script>
								...
								<a data-toggle="modal" href="#backup_delete" id="delete"  class="btn btn-success" name="" style="
    margin-left: 40px;
"><i class="icon-move icon-large"></i> Move</a>
