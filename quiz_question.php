                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="add_question.php<?php echo '?id='.$get_id; ?>" class="btn btn-info" style="
    margin-top: -3px;
"><i class="icon-plus-sign"></i> Add Question</a>
									</div>
									...
									?>                              
										...
										<td width="30">
											<input id="optionsCheckbox" class="" name="selector[]" type="checkbox" value="<?php echo $id; ?>" style="
    margin-top: -5px;
">
										</td>
												...
												<td width="30"><a href="edit_question.php<?php echo '?id='.$get_id; ?>&<?php echo 'quiz_question_id='.$id; ?>" class="btn btn-success" style="
    margin-top: -5px;
