			...
			<label>Class</label>
			<select name="class_id" class="input-block-level span12">
				<option></option>
				<?php
			...
			jQuery("#signin_student").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome to EDUVENTA Learning Management System", { header: 'Sign up Success' });
						var delay = 2000;
			...
			<a onclick="window.location='index.php'" id="btn_login" name="login" class="btn btn-info" type="submit"><i class="icon-signin icon-large"></i> Click here to Login</a>
