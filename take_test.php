                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header" style="background-color: white !important;">
...
?>
										...
										<p></p>
										Time Remaining:<div id="timer" style="color: green;">1</div>
										<div id="msg"></div>
					<script>
					jQuery(document).ready(function(){	
...
?>
	<input name="q-<?php echo $roww['quiz_question_id'];?>" value="True" type="radio" style="display: inline-block;margin-top: -3px;"> True</br><input name="q-<?php echo $roww['quiz_question_id'];?>" value="False" type="radio" style="display: inline-block;margin-top: -3px;"> False
<?php
	...
	if($rowy['choices'] == 'A') {
	?>
	A. <input name="q-<?php echo $roww['quiz_question_id'];?>" value="A" type="radio" style="display: inline-block;margin-top: -3px;"> <?php echo $rowy['answer_text'];?><br /><br />
	<?php } else if ($rowy['choices'] == 'B') {?>                                 
	B. <input name="q-<?php echo $roww['quiz_question_id'];?>" value="B" type="radio" style="display: inline-block;margin-top: -3px;"> <?php echo $rowy['answer_text'];?><br /><br />
	<?php } else if ($rowy['choices'] == 'C') {?>                                 
	C. <input name="q-<?php echo $roww['quiz_question_id'];?>" value="C" type="radio" style="display: inline-block;margin-top: -3px;"> <?php echo $rowy['answer_text'];?><br /><br />
	<?php } else if ($rowy['choices'] == 'D') {?>                                 
	D. <input name="q-<?php echo $roww['quiz_question_id'];?>" value="D" type="radio" style="display: inline-block;margin-top: -3px;"> <?php echo $rowy['answer_text'];?><br /><br />
	<?php
		}
	}
}
