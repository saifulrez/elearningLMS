                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<a href="quiz_question.php<?php echo '?id='.$get_id; ?>" class="btn btn-success" style="margin-top: -6px;"><i class="icon-arrow-left"></i> Back</a>
								</div>
                            </div>
                            <div class="block-content collapse in">
							    ...
							    <form class="form-horizontal" method="post">
										...
										<div class="control-group">
											...
											<div class="controls">			
													<div id="opt11">
														A: <input type="text" name="ans1" size="60"> <input name="answer" value="A" type="radio" style="margin-top: -3px;"><br><br>
														B: <input type="text" name="ans2" size="60"> <input name="answer" value="B" type="radio" style="margin-top: -3px;"><br><br>
														C: <input type="text" name="ans3" size="60"> <input name="answer" value="C" type="radio" style="margin-top: -3px;"><br><br>
														D: <input type="text" name="ans4" size="60"> <input name="answer" value="D" type="radio" style="margin-top: -3px;"><br><br>
													</div>
													<div id="opt12">
														<input name="correctt" value="True" type="radio" style="margin-top: -3px;"> True<br /><br />
														<input name="correctt"  value="False" type="radio" style="margin-top: -3px;"> False<br /><br />
													</div>
											</div>
										</div>
