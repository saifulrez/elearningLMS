	<div class="navbar navbar-fixed-top navbar-inverse">
           <div class="navbar-inner">
               <div class="container-fluid">
                   ...
                   <a class="brand" href="#"><img src="admin/images/Logo.png" style="
    width: 100px;
"></a>
							<div class="nav-collapse collapse">
								<ul class="nav pull-right">
												...
												?>
												<li class="dropdown">
													<a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown" style="background-color: white !important;"> <i class="icon-user icon-large"></i><?php echo $row['firstname']." ".$row['lastname'];  ?> <i class="caret"></i></a>
