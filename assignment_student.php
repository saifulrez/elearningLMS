								...
								?>
									...
									?>                              
										<tr>
										 ...
										 ?>
										  <a data-placement="bottom" title="Download" id="<?php echo $id; ?>download"  class="btn btn-info" href="<?php echo $row['floc']; ?>" style="margin-top: 0px;"><i class="icon-download icon-large"></i></a>
										<?php } ?>
