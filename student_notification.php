        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
  					...
  					<form action="read.php" method="post">
						<?php if($not_read == '0'){
							...
							<button id="delete"  class="btn btn-info" name="read" style="margin-top: -3px;"><i class="icon-check"></i> Read</button>
													<div class="pull-right">
							Check All <input type="checkbox"  name="selectAll" id="checkAll" style="margin-top: -3px;"/>
								<script>
					...
					$yes = isset($read_row['student_read']);
					...
					?>
									<div class="post"  id="del<?php echo $id; ?>">
										...
										?>
										<input id="" class="" name="selector[]" type="checkbox" value="<?php echo $id; ?>" style="margin-top: -3px;">	
										<?php } ?>	
